...
#define ZONE_NOIMMORT                                                          \
  1                  /**< Immortals (below LVL_GRGOD) cannot enter this zone */
...
#define ZONE_NOASTRAL                                                          \
  5 /**< No teleportation magic will work to or from this zone */
...
#define CON_GET_PROTOCOL                                                       \
  32                 /**< Used at log-in while attempting to get protocols > */
...
#define ITEM_ANTI_HUMAN 18      /**< Item can't be worn by human */
...
typedef char bool; /**< Technically 1 signed byte; vals should only = TRUE or
                      FALSE. */
#endif

#if !defined(CIRCLE_WINDOWS) || defined(LCC_WIN32) /* Hm, sysdep.h? */
typedef signed char
    byte; /**< Technically 1 signed byte; vals should only = TRUE or FALSE. */
#endif
...
struct recent_player {
  ...
  bool copyover_player;       /* Is this a player that was on during the last
                                 copyover? */
...
struct game_operation {
  ...
  int special_in_comm; /**< Enable use of a special character in communication
                          channels ? */
